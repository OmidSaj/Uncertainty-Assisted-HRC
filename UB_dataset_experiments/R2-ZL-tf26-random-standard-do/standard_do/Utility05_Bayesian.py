...
# Import Data
# Main_dir='C:\\Users\\Omid\\Desktop\\P4-vision aux\\Data processing\\'
Main_dir='C:\\Users\\Xiao Liang\\Desktop\\P6-Hands\\Deep learning\\Dataset\\'
filename='400x300_data'
...
Y_cat = to_categorical(Y_data, n_classes)
...
pixel_unique,pixel_count=np.unique(Y_data,return_counts=True)
...
def Monty_Model_softmax(X_set,model_test):
    SoftMaxBin_list=[]
    for i in range(n_MoteCarlo_Samples):
        SoftMaxBin_list.append(model_test.predict(X_set,batch_size=4))
